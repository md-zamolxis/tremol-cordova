 ...
 */
public class ZFPException extends java.lang.Exception
{
    ...
    static protected String getErrorStringBG(int error)
    {
        ...
        else if (0x100 < error)
        {
            switch (error)
            {
                ...
                case 0xFFF:
                    data.append("този метод не може да може да се използва!");
                    break;
        ...
        } else
        {
            ...
            switch (err)
            {
                ...
                case 0x0D:
                    ...
                    break;
                case 0x0E:
                    data.append("Ф.П.: Препълнена ЕКЛ");
                    break;
                case 0x0F:
                    data.append("Ф.П.: Недостатъчни условия");
                    break;
            ...
            switch (err)
            {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    data.append("команда: Конфликт в Дан.групи!");
                    break;
    ...
    static protected String getErrorStringEN(int error)
    {
        ...
        else if (0x100 < error)
        {
            switch (error)
            {
                ...
                case 0xFFF:
                    data.append("method deprecated, use another method!");
                    break;
        ...
        } else
        {
            ...
            switch (err)
            {
                ...
                case 0x0D:
                    ...
                    break;
                case 0x0E:
                    data.append("F.P.: EJ overflow");
                    break;
                case 0x0F:
                    data.append("F.P.: Not enough conditions met");
                    break;
            ...
            switch (err)
            {
                ...
                case 9:
                    data.append("command: conflict Tax groups!");
                    break;
